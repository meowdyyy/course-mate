                  ...
                  <div className="flex justify-between items-start">
                    <div className="pr-4">
                      ...
                      <p className="text-sm text-gray-600 break-all">
                        <button onClick={() => setPreviewResource(r)} className="text-blue-600 underline mr-2">Preview</button>
          ...
          <form id="add-student-resource" onSubmit={editingResource ? handleUpdateResource : handleAddResource} className="mt-6 space-y-4 border-t pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" value={newResource.semester} onChange={e => setNewResource(prev => ({ ...prev, semester: e.target.value }))} className="input" required placeholder="e.g., Summer 2025" />
              </div>
            </div>

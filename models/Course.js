...
// Backward compatibility: virtual 'instructor' aliasing to 'owner'
courseSchema.virtual('instructor').get(function() { return this.owner; });
courseSchema.set('toJSON', { virtuals: true });
courseSchema.set('toObject', { virtuals: true });

// Backfill legacy documents that still have 'instructor' instead of 'owner'
courseSchema.pre('validate', function(next) {
  if (!this.owner) {
    // Some legacy documents may still hold an 'instructor' field in raw doc
